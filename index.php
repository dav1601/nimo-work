...
<body>
    <script>
        $(function () {
            ...
            $("#down").click(function () {
                downloadURI("https://res.cloudinary.com/vanh-tech/image/upload/v1650210955/new-update_urkhig.png","thuy-do.png");
            });
        });
    </script>
    <style>
    ...
    <div id="wrapper">
            <div class="row mx-0 justify-content-center align-items-center my-2">
                ...
                <a href="https://res.cloudinary.com/vanh-tech/image/upload/fl_attachment/v1650210955/new-update_urkhig.png"  class="btn btn-primary col-2">Tải về</a>
            </div>
        <div class="container-fluid py-4" id="export">
            <header>
                ...
                <div class="d-flex justify-content-center align-items-center brush-wrap">
                    <h1 class="text-center text-uppercase   d-inline-block main-header"
                        style="margin-right: 6rem!important;">
                        Chính sách Nimo</h1>
                </div>
            </header>
            <div id="table" class="pt-0">
                <div class="d-flex justify-content-center align-items-center">
                    <h2 class="text-center text-uppercase font-weight-bold  d-block"
                        style="font-size: 20px; margin-bottom: 10px !important;">
                        Chính sách idol thường và độc quyền nimoshow (16 days / 31h)</h2>
                </div>
                <table class="table table-bordered mb-0">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class=""><span class="d-block mb-1"
                                    style="border-bottom: 2px solid var(--text-color); padding-bottom: 2px ;">Đá
                                    rút<strong>(USD)</strong></span><span>Tổng đá/285</span>
                            </th>
                            <th scope="col">Thưởng <strong>(USD)</strong></th>
                            <th scope="col" class="group-1">Tổng <strong>(USD)</strong></th>
                            <th scope="col" class="group-1">Tổng <strong>(VNĐ)</strong></th>
                            <th scope="col" class=""><span class="d-block mb-1"
                                    style="border-bottom: 2px solid var(--text-color); padding-bottom: 2px ;">Bonus độc
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>18</td>
                            <td>9</td>
                            <td class="group-1">41</td>
                            <td class="group-1">943.248</td>
                            <td>0</td>
                        </tr>
                        <tr>
                            <td>F</td>
                            ...
                            <td>35</td>
                            <td>16</td>
                            <td class="group-1">79</td>
                            <td class="group-1">1.817.921</td>
                            <td>0</td>
                        </tr>
                        <tr>
                            <td>E</td>
                            ...
                            <td>105</td>
                            <td>47</td>
                            <td class="group-1">219</td>
                            <td class="group-1">5.035.525</td>
                            <td>0</td>
                        </tr>
                        <tr>
                            <td>D</td>
                            ...
                            <td>175</td>
                            <td>81</td>
                            <td class="group-1">384</td>
                            <td class="group-1">8.842.626</td>
                            <td>0</td>
                        </tr>
                        <tr>
                            <td>C</td>
                            ...
                            <td>351</td>
                            <td>141</td>
                            <td class="group-1">748</td>
                            <td class="group-1">17.203.921</td>
                            <td>0</td>
                        </tr>
                        <tr>
                            <td>B</td>
                            ...
                            <td>526</td>
                            <td>239</td>
                            <td class="group-1">1.203</td>
                            <td class="group-1">27.665.500</td>
                            <td>0</td>
                        </tr>
                        <tr>
                            <td>A</td>
                            ...
                            <td>1.053</td>
                            <td>508</td>
                            <td class="group-1">2.417</td>
                            <td class="group-1">55.603.031</td>
                            <td>0</td>
                        </tr>
                        <tr>
                            <td class="sp">S</td>
                            ...
                            <td>1.754</td>
                            <td>815</td>
                            <td class="group-1">3.916</td>
                            <td class="group-1">90.077.180</td>
                            <td>20</td>
                        </tr>
                        <tr>
                            ...
                            <td>3.509</td>
                            <td>1.549</td>
                            <td class="group-1">7.410</td>
                            <td class="group-1">170.435.034</td>
                            <td>50</td>
                        </tr>
                        <tr>
                            ...
                            <td>5.263</td>
                            <td>1.929</td>
                            <td class="group-1">10.214</td>
                            <td class="group-1">234.918.090</td>
                            <td>60</td>
                        </tr>
                        <tr>
                            ...
                            <td>7.018</td>
                            <td>2.316</td>
                            <td class="group-1">12.938</td>
                            <td class="group-1">297.518.130</td>
                            <td>75</td>
                        </tr>
                        <tr>
                            ...
                            <td>10.526</td>
                            <td>3.300</td>
                            <td class="group-1">18.687</td>
                            <td class="group-1">429.806.620</td>
                            <td>75</td>
                        </tr>
                        <tr>
                            ...
                            <td>14.035</td>
                            <td>4.300</td>
                            <td class="group-1">24.572</td>
                            <td class="group-1">565.151.423</td>
                            <td>80</td>
                        </tr>
                        <tr>
                            ...
                            <td>17.544</td>
                            <td>5.123</td>
                            <td class="group-1">30.291</td>
                            <td class="group-1">696.693.690</td>
                            <td>85</td>
                        </tr>
                        <tr>
                            ...
                            <td>26.316</td>
                            <td>7.250</td>
                            <td class="group-1">43.898</td>
                            <td class="group-1">1.009.644.570</td>
                            <td>100</td>
                        </tr>
                        <tr>
                            ...
                            <td>35.088</td>
                            <td>9.050</td>
                            <td class="group-1">57.210</td>
                            <td class="group-1">1.315.812.760</td>
                            <td>100</td>
                        </tr>
                    </tbody>
                </table>
            ...
            <footer class="mt-2">
                ...
                <div class="brush-wrap" id="h1-footer">
                    <h1 class="d-inline-block">Lưu Ý:</h1>
                </div>
                <ol>
                    <style>
                        ol li {
                    ...
                    <li>live tối thiểu 16 ngày 31 giờ , 1 lần live trên 30p được tính 1 ngày.</li>
                    <li>up 3 post facebook thiếu 1 post trừ 10% thu nhập, hạn up trước ngày 21.</li>
                    <li>idol độc quyền có chính sách riêng (chạy 500k đá / tháng sau được đăng ký)</li>
                    <li>idol live đủ ngày giờ mới nhận lương theo mốc (chốt ngày 25 hàng tháng)</li>
                    <li>trước ngày 10 phải live tối thiểu 4 tiếng trong 4 ngày thì mới được xác nhận hợp đồng nhận
                        lương.</li>
                    </ul>
            </footer>
        </div>
