    ...
    <div id="wrapper">
        ...
        <div class="container-fluid py-4" id="export">
            ...
            <div id="table" class="pt-0">
                <div class="d-flex justify-content-center align-items-center">
                    <h2 class="text-center text-uppercase font-weight-bold  d-block" style="font-size: 20px; margin-bottom: 10px !important;">
            ...
            <footer class="mt-2">
                ...
                <ol>
                    ...
                    <li>trước ngày 10 phải live tối thiểu 4 tiếng trong 4 ngày thì mới được xác nhận hợp đồng nhận lương.</li>
                </ul>
            </footer>
        </div>
    </div>
